            ...
            >
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-4">
                <p className="text-sm font-bold text-green-700 dark:text-green-300 mb-2">
                  🎁 Get £10 Free Bitcoin When You Sign Up!
                </p>
                <ul className="text-xs text-green-600 dark:text-green-400 space-y-1">
                  <li>✅ £10 free bonus - no deposit required</li>
                  <li>✅ 0.25% fees - 6x cheaper than Coinbase</li>
                  <li>✅ Instant GBP deposits via Stripe</li>
                  <li>✅ Trade BTC, ETH, SOL, and more</li>
                </ul>
              </div>
